...
export type TaskCode = 'READING' | 'ICE_CREAM' | 'OFFICE_DUTY' | 'CLEANING'
...
export interface AppData { branches: Branch[]; taskTypes: TaskType[]; members: Member[]; classes: ClassGroup[]; schedules: Schedule[]; rotation: ReadingRotationConfig; notifications: AppNotification[] }
